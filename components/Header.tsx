...
const Header: React.FC = () => {
  return (
    <header className="pt-20 pb-12 text-center">
      ...
      >
        The <span className="text-transparent bg-gradient-to-r from-cyan-600 via-blue-600 to-purple-700 bg-clip-text">Automation Idea</span> Bank
      </motion.h1>
      ...
      >
        Over 200 premium workflows and AI-powered strategies to scale your 
        career, eliminate grunt work, and supercharge your business.
      </motion.p>
    </header>
  );
};
